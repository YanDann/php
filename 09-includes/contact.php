...
if (!empty($_POST)) {
    ...
    if (count($skills) < 1) {
        $errors[] = "Vous devez choisir au moins une competence.";
...
<div class="container py-5">
    ...
    <form method="post">
        ...
        <div class="mb-3">
            ...
            <div class="form-check">
                <input type="checkbox" id="js" name="skills[]" value="js" <?= checked('ks', $skills) ?> class="form-check-input">
