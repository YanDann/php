...
// Ouvrir le fichier
$file = fopen('data/exports/categories.csv', 'r');
...
//-------------------------------------------------------------------------
$movies = convertCsvToArray('data/exports/movies.csv');
...
$actors = convertCsvToArray('data/exports/actors.csv');
...
$movieActors = convertCsvToArray('data/exports/movie_has_actor.csv');
